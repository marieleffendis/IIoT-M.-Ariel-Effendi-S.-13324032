...
class DirectControlPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.create_btn(grid_frame, "1", "main.py", 0, 0)
        self.create_btn(grid_frame, "2", "main.py", 0, 1)
        self.create_btn(grid_frame, "3", "main.py", 0, 2)
        self.create_btn(grid_frame, "3", "main.py", 0, 2)
        self.create_btn(grid_frame, "4", "main.py", 0, 3)
        self.create_btn(grid_frame, "5", "main.py", 1, 0)
        self.create_btn(grid_frame, "6", "main.py", 1, 1)
        self.create_btn(grid_frame, "7", "main.py", 1, 2)
        self.create_btn(grid_frame, "8", "main.py", 1, 3)
        self.create_btn(grid_frame, "9", "main.py", 2, 0)
        self.create_btn(grid_frame, "10", "main.py", 2, 1)
        self.create_btn(grid_frame, "11", "main.py", 2, 2)
        self.create_btn(grid_frame, "12", "main.py", 2, 3)
        self.create_btn(grid_frame, "13", "main.py", 3, 0)
        self.create_btn(grid_frame, "14", "main.py", 3, 1)
        self.create_btn(grid_frame, "15", "main.py", 3, 2)
        self.create_btn(grid_frame, "16", "main.py", 3, 3)
